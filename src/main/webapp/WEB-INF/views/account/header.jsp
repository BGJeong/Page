	...
	<nav class="navbar navbar-light bg-light">
		<div class="container-sm" style="width:80%;">
			...
			<form class="d-flex">
				...
				<a href="modal.do" class="btn">
					<img src="https://cdn.jsdelivr.net/gh/bgjeong/cdn/plus_flat.png" style="width:2rem;"class="">
				</a>
				
				<a href="search.do" class="btn">
					<img src="https://cdn.jsdelivr.net/gh/bgjeong/cdn/search.png" style="width:2rem;"class="">
				</a>
				<a href="mypage.do" class="btn">
					<img src="<%=request.getContextPath() %>/upload/${pimg}" style="width:2rem;"class="rounded-circle">
				</a>
			</form>
		</div>
	</nav>
